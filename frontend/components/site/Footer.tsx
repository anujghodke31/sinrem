    ...
    <footer className="border-t border-border mt-20 bg-muted/5">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8 grid gap-12 grid-cols-2 md:grid-cols-4">
        ...
        <div className="col-span-2 md:col-span-1">
          <div className="text-base font-bold text-text">{site.name}</div>
        ...
        {/* Explore Column */}
        <div>
          <div className="font-semibold text-text mb-6">Explore</div>
        ...
        {/* Account Column */}
        <div>
          <div className="font-semibold text-text mb-6">Account</div>
          <div className="grid gap-3 text-sm text-foreground/60">
        ...
        {/* Contact Column */}
        <div>
          <div className="font-semibold text-text mb-6">Contact</div>
          <div className="grid gap-3 text-sm text-foreground/60">
            ...
            <div className="flex gap-4 pt-4">
              <a
                href="https://www.linkedin.com/company/sinrem-tech/"
                target="_blank"
                rel="noreferrer"
                className="text-foreground/60 hover:text-brand-500 transition-colors"
                aria-label="LinkedIn"
              >
                <Linkedin size={20} />
              </a>
              <a
                href="https://www.instagram.com/sinrem_"
                target="_blank"
                rel="noreferrer"
                className="text-foreground/60 hover:text-brand-500 transition-colors"
